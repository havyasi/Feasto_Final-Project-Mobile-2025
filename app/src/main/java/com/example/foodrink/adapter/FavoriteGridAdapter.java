...
public class FavoriteGridAdapter extends RecyclerView.Adapter<FavoriteGridAdapter.ViewHolder> {
    ...
    public FavoriteGridAdapter(List<RecipeResponse> favoriteRecipes) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        RecipeResponse recipe = favoriteRecipes.get(position);
    ...
    public void updateData(List<RecipeResponse> newFavorites) {
        this.favoriteRecipes = newFavorites;
